#ifndef CONFIG_BOARD_AD6983E_DEMO_CFG_H
#define CONFIG_BOARD_AD6983E_DEMO_CFG_H

#ifdef CONFIG_BOARD_AD6983E_DEMO
...
//                                  低功耗配置                                     //
//*********************************************************************************//
#define TCFG_LOWPOWER_POWER_SEL				PWR_LDO15                    //AD6983E电源模式设置，仅支持LDO
...
//                                 配置结束                                        //
//*********************************************************************************//
#if (TCFG_MIC_CAPLESS_ENABLE && (!TCFG_SUPPORT_MIC_CAPLESS))      // 3:PWR_DCDC15
#error "需要使能TCFG_SUPPORT_MIC_CAPLESS"
#endif
//

#endif //CONFIG_BOARD_AD6983E_DEMO
#endif //CONFIG_BOARD_AD6983E_DEMO_CFG_H
