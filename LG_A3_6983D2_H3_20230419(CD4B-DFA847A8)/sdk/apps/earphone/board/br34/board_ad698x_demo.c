...
u8 key_table[KEY_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    {KEY_MUSIC_PP,   KEY_lONG_CLICK,    KEY_NULL,           KEY_NULL,     KEY_DOUBLE_CLICK,     KEY_THREE_CLICK},   //KEY_0
...
LCD_SPI_PLATFORM_DATA_BEGIN(lcd_spi_data)
    ...
    .pin_reset	= IO_PORTB_01,//IO_PORTC_01, 注意引脚是否可用（openKM）
    .pin_cs		= IO_PORTC_03,
    .pin_rs		= IO_PORTC_02,
    .pin_bl     = IO_PORTB_02,//IO_PORTC_00,
#else
    .pin_reset	= -1,
    .pin_cs		= IO_PORTC_03,
    .pin_rs		= IO_PORTC_02,
...
#endif /* #ifdef CONFIG_BOARD_AD698X_DEMO */
