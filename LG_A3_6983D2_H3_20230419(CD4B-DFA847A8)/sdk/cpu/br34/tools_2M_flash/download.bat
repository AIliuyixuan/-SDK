...
%LZ4_PACKET% -dict text.bin -input common.bin 0 aec.bin 0 !bankfiles! -o bank.bin
...
isd_download.exe -tonorflash -dev br34 -boot 0x20000 -div8 -wait 300 -uboot uboot.boot -app app.bin cfg_tool.bin  -res tone.cfg p11_code.bin -uboot_compress -key 023AC690X-6451.key
:: -format all
